...
# Script to restart monitoring stack with Promtail for complete Docker container log collection
# This script restarts the entire monitoring stack to include Promtail

set -e

echo "🔄 Restarting monitoring stack with Promtail for complete Docker log collection..."
...
# Start the monitoring stack with Promtail
echo "🚀 Starting monitoring stack with Promtail..."
docker-compose up -d
...
echo ""
echo "✅ Monitoring stack restarted successfully with Promtail!"
echo ""
echo "🔗 Access URLs:"
...
echo "   • Promtail is now collecting logs from ALL Docker containers"
...
echo ""
echo "🔄 Promtail is now monitoring all Docker containers!" 